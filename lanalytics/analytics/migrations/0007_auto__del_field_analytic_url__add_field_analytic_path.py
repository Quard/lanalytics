...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Analytic.url'
        db.delete_column('analytics_analytic', 'url')

        # Adding field 'Analytic.path'
        db.add_column('analytics_analytic', 'path', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Analytic.url'
        db.add_column('analytics_analytic', 'url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200), keep_default=False)

        # Deleting field 'Analytic.path'
        db.delete_column('analytics_analytic', 'path')
