...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Analytic.site'
        db.add_column('analytics_analytic', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='analytics', to=orm['statistic.Site']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Analytic.site'
        db.delete_column('analytics_analytic', 'site_id')
