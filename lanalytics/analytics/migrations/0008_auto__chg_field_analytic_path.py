...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Analytic.path'
        db.alter_column('analytics_analytic', 'path', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Analytic.path'
        db.alter_column('analytics_analytic', 'path', self.gf('django.db.models.fields.URLField')(max_length=200))
