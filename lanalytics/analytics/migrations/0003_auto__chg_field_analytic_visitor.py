...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Analytic.visitor'
        db.alter_column('analytics_analytic', 'visitor', self.gf('django.db.models.fields.IPAddressField')(max_length=15))


    def backwards(self, orm):
        
        # Changing field 'Analytic.visitor'
        db.alter_column('analytics_analytic', 'visitor', self.gf('django.db.models.fields.CharField')(max_length=32))
