...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field share_with on 'Site'
        db.create_table('statistic_site_share_with', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('site', models.ForeignKey(orm['statistic.site'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('statistic_site_share_with', ['site_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field share_with on 'Site'
        db.delete_table('statistic_site_share_with')
    ...
    models = {
        ...
        'statistic.site': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lanalytic_sites'", 'to': "orm['auth.User']"}),
            'share_with': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'share_sites'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
